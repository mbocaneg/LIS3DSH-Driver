...
*Usage
In order to use this driver, the following function pointers must be populated:
...
function (after calling the LIS3DSH_readXYZ(&lis3dsh) function), giving it arguments
